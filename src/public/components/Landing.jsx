        ...
        return (
            <div className="landing">
                ...
                <section className="landing__section">
                    ...
                    <section className="landing__section__container col-md-6 col-md-offset-3">
                        <p>
                        ...
                        <p>
                            Fusce interdum tincidunt ipsum in ornare. Vestibulum finibus turpis ante, sit amet ornare
                            est
                            auctor placerat. Ut vitae blandit quam, eleifend rhoncus metus. Proin hendrerit nunc id
                            dolor
                            interdum rutrum. Phasellus faucibus, erat id dapibus facilisis, arcu nisl hendrerit odio, et
                            ...
                            ultrices felis nec efficitur. Donec lorem erat, fermentum id sollicitudin a, auctor sit amet
                            quam. Curabitur elementum, dui in placerat tincidunt, lorem nisi finibus erat, ut euismod
                            diam
                            ipsum sed lectus. Nullam eget ullamcorper est.
                        </p>
                        <p>
                            Phasellus condimentum lacus arcu, at sodales neque semper in. Sed ut enim sed purus mollis
                            auctor sit amet blandit quam. In rutrum venenatis aliquam. Sed sed ipsum velit. Aenean eget
                            libero lacus. Mauris egestas facilisis magna eget interdum. Etiam urna nulla, viverra
                            commodo
                            lorem in, molestie posuere urna. Praesent ante purus, accumsan quis porta id, rhoncus vitae
                            urna. Phasellus condimentum ante sed malesuada mattis. Pellentesque habitant morbi tristique
                            senectus et netus et malesuada fames ac turpis egestas. Suspendisse tincidunt velit at
                            vestibulum mollis. In pellentesque metus ac lorem condimentum auctor. Quisque mollis, lorem
                            eget
                ...
                <section className="landing__section landing__section--primary">
                    ...
                    <section className="landing__section__container col-md-6 col-md-offset-3">
                        ...
                        <p>
                            ...
                            euismod.
                            Cras cursus augue arcu, a vehicula massa maximus et. Aliquam eu turpis ac tortor eleifend
                            faucibus.
                        ...
                        <p>
                            ...
                            Vivamus
                            consectetur tellus ac mauris elementum, id volutpat tortor fringilla. Aliquam dignissim nibh
                            ac
                            orci
                            congue, gravida hendrerit purus egestas. Suspendisse potenti. Nullam egestas rutrum magna at
                            varius.
                            ...
                            aliquam
                            lobortis tempor. Quisque sit amet accumsan lacus, non dictum odio. Phasellus pulvinar enim a
                            felis
                            ullamcorper consequat. Aliquam magna magna, ultrices eu molestie et, facilisis non turpis.
                            Duis
                            at
                ...
                <section className="landing__section">
                    ...
                    <section className="landing__section__container col-md-6 col-md-offset-3">
                        <p>
                            ...
                            tristique odio. Pellentesque nibh turpis, vulputate a ante in, mattis pretium nunc. Praesent
                            volutpat, lorem ut congue tempus, eros justo pretium ex, in auctor purus lacus sed nulla.
                            Nam quis viverra quam.
                        </p>
                        <p>
                            Nullam sed tempus felis. Sed mollis risus et odio imperdiet faucibus. Maecenas vestibulum
                            diam vitae egestas aliquet. Proin commodo et neque vitae efficitur. Praesent et ante eu nibh
                            lacinia faucibus aliquet aliquam nibh. Vivamus a consequat diam. Morbi ornare consequat quam
                            a semper. Phasellus ac libero ut mi dignissim convallis eu ac nulla.
                        </p>
                        <p>
                            Duis dictum facilisis nibh, ac aliquet mi convallis ut. Curabitur faucibus venenatis eros
                            eget dictum. Sed non fermentum ex. Donec pellentesque condimentum est. Phasellus porttitor
                            turpis sed ligula convallis condimentum. Nunc semper ornare enim rutrum gravida. Fusce id
                            nibh accumsan, sollicitudin risus vitae, placerat mauris. Vivamus gravida odio a scelerisque
