...
export const confirmationPageRoute = (giftSetId: number): string => `confirmation/${giftSetId}`;
...
export const giftSetRoute = (giftSetId: number): string => `${GIFT_SETS_ROUTE}/${giftSetId}`;
...
export const updateWeddingPartyMemberRoute = (memberId: number): string => `${WEDDING_PARTY_MEMBERS_ROUTE}/${memberId}`;

export const SECTIONS_ROUTE = `${ADMIN_ROUTE}/section`;
export const CREATE_SECTION_ROUTE = `${SECTIONS_ROUTE}/create`;
export const updateSectionRoute = (sectionId: number): string => `${SECTIONS_ROUTE}/${sectionId}`;
