...
export default function GiverDetailsForm(
  {
    giver: { forename, surname, email, phoneNumber, paymentMethod },
    saving,
    onChange,
    onRadioChange,
    onSubmit,
        ...
        <Paper>
          ...
          <Form onSubmit={onSubmit} loading={false} saving={saving} style={styles.form}>
            ...
            <RadioButtonGroup name="paymentMethod" valueSelected={paymentMethod} onChange={onRadioChange}>
              <RadioButton label="PayPal" value={PAYMENT_METHODS.PAYPAL} disabled={saving} style={styles.radioButton} />

              <RadioButton label="Bank Transfer" value={PAYMENT_METHODS.BANK_TRANSFER} disabled={saving} style={styles.radioButton} />
            </RadioButtonGroup>

            <div className={css.actions}>
              <RaisedButton primary type="submit" label={saving ? 'Completing Gift...' : 'Complete Gift'} disabled={saving} style={styles.button} />
