...
export default function MarkdownHelp({ open, handleClose }: PropsType) {
  const actions = [<FlatButton label="Close" onTouchTap={handleClose} />];

  return (
    <Dialog title="Markdown Help" actions={actions} open={open} onRequestClose={handleClose} autoScrollBodyContent>
